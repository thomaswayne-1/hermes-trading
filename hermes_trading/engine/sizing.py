...
def fractional_kelly_size(
    ...
    *,
    ...
    # Take floor size whenever |C| exceeds the entry threshold so the engine
    # can accumulate trade history from the first entry. The floor_threshold
    # defaults to tau_enter (0.12) and is passed in from _maybe_open_engine.
